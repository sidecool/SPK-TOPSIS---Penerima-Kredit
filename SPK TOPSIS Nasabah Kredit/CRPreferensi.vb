...
Public Class CRPreferensi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_TOPSIS_Nasabah_Kredit.CRPreferensi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPreferensi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPreferensi = New CRPreferensi
        rpt.Site = Me.Site
        Return rpt
    End Function
